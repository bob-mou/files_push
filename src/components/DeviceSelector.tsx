  ...
  return (
    <div className="relative flex items-center electron-no-drag">
      <button
        ...
        className="flex items-center space-x-1 px-2 py-2 bg白 rounded-lg shadow-md hover:shadow-lg transition-shadow"
      ...
      <button
        ...
        className="ml-2 p-3 bg白 rounded-lg shadow-md hover:shadow-lg transition-shadow"
      ...
      {/* 设备下拉列表 */}
      {isOpen && (
        <div className="absolute space-x-0 top-full mt-2 w-58 bg白 rounded-lg shadow-lg border z-10">
          <div className="p-2">
            {devices.length === 0 ? (
