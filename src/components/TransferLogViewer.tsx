    ...
    <div className="p-3 space-y-1 leading-tight">
      ...
      {stats && (
        <div className="bg-gray-50 rounded-lg pt-1 pb-2">
          ...
          <div className="mt-1 flex justify中心 space-x-2 text-lg gap-x-10">
      ...
      <div className="flex justify之间 items-center">
        ...
        <div className="flex space-x-2">
          ...
          <button
            onClick={exportLogs}
            className="px-3 py-1 text-sm bg-blue-100 text-blue-700 rounded hover:bg-blue-600 flex items中心 space-x-1"
          >
      ...
      <div className="space-y-2">
        {logs.length === 0 ? (
          ...
          logs.map((log, index) => (
            <div key={index} className="bg白 border rounded-lg p-3 shadow-sm">
