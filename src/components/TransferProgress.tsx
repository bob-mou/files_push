...
export function TransferProgress() {
  ...
  return (
    <div className="fixed inset-0 bg黑 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg白 rounded-lg p-6 w-96 shadow-xl">
        ...
        <div className="space-y-3">
          ...
          {status === 'completed' && (
            <div className="flex items中心 space-x-2 text-green-600">
              <div className="w-5 h-5 bg-green-500 rounded-full flex items中心 justify-center">
          ...
          {status === 'error' && (
            <div className="flex items中心 space-x-2 text-red-600">
              <div className="w-5 h-5 bg-red-500 rounded-full flex items中心 justify-center">
                <svg className="w-3 h-3 text白" fill="currentColor" viewBox="0 0 20 20">
