...
export function SettingsModal({ onClose }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg黑 bg-opacity-10 flex items-center justify-center z-10">
      <div className="bg白 rounded-lg w-full max-w-[90vw] sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-5xl max-h-[85vh] overflow-hidden shadow-l flex flex-col">
          ...
          {activeTab === 'general' && (
            <div className="space-y-1 p-3 leading-tight">
              <div className="flex items-center justify-between">
                <div className="flex flex-wrap items中心 gap-1.5">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items中心 space-x-1.5">
        ...
        {activeTab === 'general' && (
          <div className="flex justify-between p-3 border-t bg-gray-50">
            <button
              onClick={handleReset}
              className="px-3 py-1.5 text-sm font-medium text-gray-700 bg灰-100 rounded-md hover:bg灰-200 transition-colors flex items中心 space-x-1.5"
            >
